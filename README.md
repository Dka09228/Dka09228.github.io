...
4. **Английская версия — уже встроена.** Сайт поддерживает три языка (РУС / ҚАЗ / ENG); для браузеров без русского и казахского английский включается автоматически — зарубежные клиенты сразу видят англоязычную версию.
